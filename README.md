...
I'm **Tejas Patil**, an aspiring Software Engineer and Full-Stack Developer with strong experience in **Next.js, MERN, React Native, and AI-driven systems**.
...
- 🧠 Passionate about production-grade engineering and automation
...
**AI/ML:** NLP, LLMs, Generative AI, Hugging Face, LangChain, Agentic AI  
**Tools:** Git, Docker, Postman, GitHub Actions, JavaFX, n8n  

## 💼 Experience
### Software Developer Intern — Delxn Technologies (2025)
- Worked onsite on Dubai-based large-scale construction system **SkyStruct V2 Lite**
- Contributed to production deployments and feature development
- Collaborated with senior engineers on real-world modules
...
- Delivered responsive UIs during Agile sprints

### MERN Stack Intern — EY GDS & Edunet Foundation (Feb 2025 – Mar 2025)
- Built a production MERN Expense Manager for 100+ users
...
- Phone-camera barcode scanning for billing & stock automation (no external hardware)
...
- Role-based access with secure Firestore rules
- Reduced screening effort by ~70% using GenAI automation
...
Bachelor of Engineering (IT) — **CGPA: 8.5/10**
